...
You may think it too easy to print only `Hello, world!` . After all, **it doesn't meet with science geeks' imagination for a better future**.
...
```c
test5g;
//Equivalent to the code "test5g music;"
```

Or you can use another mode:
...
Follow [KizunaAI](https://space.bilibili.com/1473830)! Super cool Super AI violently kills cyber Tenzin!
